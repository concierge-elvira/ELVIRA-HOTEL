...
import { StayDetailsCard } from "../../../../guest/shared/cards";
import {
  CategoryMenu,
  type CategoryType,
} from "../../../../guest/shared/menus";
import { CategoryCard } from "../../../../guest/shared/category-cards/CategoryCard";
import {
  PreviewHeader,
  PreviewTicker,
  PreviewBottomNav,
  ...
  return (
    <div className="max-w-md mx-auto bg-white">
      ...
      <main className="pb-16">
        ...
        <div className="px-4 pt-4 pb-2 bg-linear-to-br ">
          <StayDetailsCard
        ...
        <div className="bg-white">
          <CategoryMenu onCategoryChange={setPreviewCategory} />
        </div>
